      ...
      <div className="container max-w-4xl mx-auto px-6 my-10 lg:my-20">
        ...
        <section>
          <div className="bg-slate-200 rounded-2xl shadow-lg">
            <form
              action="https://poolbuildergrowth.us4.list-manage.com/subscribe/post?u=9709f951450aedeb01b57d0ed&amp;id=6e4c434319&amp;f_id=008895e3f0"
              method="post"
            ...
            >
              <div id="mc_embed_signup_scroll">
                ...
                <div hidden="">
                  <input type="hidden" name="tags" value="4531400" />
                </div>
...
// <!-- Google tag (gtag.js) -->
// <script async src="https://www.googletagmanager.com/gtag/js?id=AW-17704226239"></script>
// <script>
//   window.dataLayer = window.dataLayer || [];
//   function gtag(){dataLayer.push(arguments);}
//   gtag('js', new Date());

//   gtag('config', 'AW-17704226239');
// </script>
