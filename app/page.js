...
const Home = () => {
  ...
  const organizationSchema = {
    ...
    "description": "Pool builder marketing specialist helping pool construction companies grow their business through digital marketing, SEO, and lead generation systems.",
  ...
  const serviceSchema = {
    ...
    "description": "Comprehensive digital marketing services specifically designed for pool construction companies including SEO, website design, lead generation, and automated follow-up systems.",
    "provider": {
      "@type": "Organization",
      "name": "Pool Builder Growth"
    },
    ...
    "offers": {
      "@type": "Offer",
      "description": "Pool builder marketing services starting from $2,000-$5,000 per month",
  ...
  const localBusinessSchema = {
    ...
    "name": "Pool Builder Growth",
    "description": "Pool builder marketing specialist providing digital marketing services to pool construction companies nationwide.",
    "url": "https://poolbuildergrowth.com",
  ...
  const websiteSchema = {
    ...
    "name": "Pool Builder Growth",
    "url": "https://poolbuildergrowth.com",
    "description": "Pool builder marketing that creates a full marketing system for your business. Partner with a pool builder marketing specialist.",
    "publisher": {
      "@type": "Organization",
      "name": "Pool Builder Growth"
    },
