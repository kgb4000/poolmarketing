    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <QuestionItem id="q1" question="How much should pool builders spend on marketing per month?">
          ...
          <QuestionItem id="q2" question="What is the best marketing strategy for pool builders in 2025?">
          ...
          <QuestionItem id="q3" question="How do pool builders get more leads without spending a fortune on advertising?">
          ...
          <QuestionItem id="q4" question="What's the average cost per lead for pool builder marketing campaigns?">
        ...
        <div className="mb-12">
          ...
          <QuestionItem id="q5" question="Should pool builders use Google Ads or Facebook Ads for better results?">
          ...
          <QuestionItem id="q6" question="How can pool builders rank #1 on Google for local searches?">
          ...
          <QuestionItem id="q7" question="What social media platforms work best for pool builder marketing?">
          ...
          <QuestionItem id="q8" question="How do pool builders create content that actually generates leads?">
        ...
        <div className="mb-12">
          ...
          <QuestionItem id="q9" question="How do pool builders convert website visitors into qualified leads?">
          ...
          <QuestionItem id="q10" question="What's the best way for pool builders to follow up with leads who don't respond?">
        ...
        <div className="mb-12">
          ...
          <QuestionItem id="q11" question="Is SEO worth it for pool builders and cleaners?">
            <p><strong>Direct Answer:</strong> Yes, SEO is highly worth it for pool businesses. 90% of customers discover pool builders through organic Google results, and SEO generates leads at $25-$100 per lead compared to $100-$300 for Google Ads.</p>

            <div>
              <p><strong>Why SEO Works for Pool Companies:</strong></p>
              
              <p><strong>Long-Term Value:</strong><br/>
              SEO builds lasting authority that generates leads for years. Unlike ads that stop when you stop paying, SEO compounds over time.</p>

              <p><strong>High-Intent Traffic:</strong><br/>
              People searching "pool builders near me" or "pool cleaning service" are actively looking for your services, leading to higher conversion rates than cold advertising.</p>

              <p><strong>Local Market Dominance:</strong><br/>
              Pool businesses serve specific geographic areas. Local SEO helps you dominate your service area and capture customers before they find competitors.</p>
            </div>

            <div>
              <p><strong>ROI for Pool Businesses:</strong></p>
              <p>Well-executed SEO campaigns generate 3:1 to 5:1 return on investment. For pool builders, one new customer from SEO can generate $50,000+ in revenue, making the investment extremely profitable.</p>
            </div>

            <p><strong>Best for:</strong> Pool builders, cleaning services, maintenance companies, and pool supply businesses serving local markets.</p>
          </QuestionItem>

          <QuestionItem id="q12" question="What's the difference between SEO and paid ads for pool companies?">
            <p><strong>Direct Answer:</strong> SEO builds long-term organic visibility while paid ads provide immediate but temporary results. Pool companies should use both strategically: 60% budget on Google Ads for immediate leads, 40% on SEO for long-term growth.</p>
            ...
            <div>
              <p><strong>Paid Ads Advantages:</strong></p>
              <ul className="ml-6 space-y-1 mt-2">
            ...
            <div>
              ...
              <p>Smart pool companies use SEO for long-term growth and ads for immediate results. SEO takes 6-12 months to show results but provides lasting value. Ads work immediately but stop when you stop paying.</p>
            </div>

            <p><strong>Timeline:</strong> Use ads to generate leads while building SEO. After 12-18 months, SEO should generate 50%+ of your leads organically.</p>
          </QuestionItem>

          <QuestionItem id="q13" question="Do I need SEO if I already run Google Ads?">
            <p><strong>Direct Answer:</strong> Yes, you still need SEO even with Google Ads. SEO and ads work together to dominate search results, increase brand trust, and reduce your overall cost per lead over time.</p>

            <div>
              <p><strong>Why Both Are Essential:</strong></p>
              
              <p><strong>Search Results Domination:</strong><br/>
              When you appear in both organic results and ads, you occupy more real estate on the search page, increasing click-through rates and brand visibility.</p>

              <p><strong>Trust and Credibility:</strong><br/>
              Customers trust organic results more than ads. Having strong organic rankings validates your paid ad presence and increases overall conversions.</p>

              <p><strong>Cost Reduction Over Time:</strong><br/>
              As SEO improves, you can reduce ad spend on keywords where you rank organically, lowering your overall marketing costs while maintaining lead volume.</p>
            </div>

            <div>
              <p><strong>Strategic Benefits:</strong></p>
              <ul className="ml-6 space-y-1 mt-2">
                <li>• SEO captures research-phase customers that ads often miss</li>
            ...
            <p><strong>Smart Approach:</strong> Use ads for immediate results while building SEO for long-term success. This combination creates a sustainable lead generation system that becomes more cost-effective over time.</p>
          </QuestionItem>

          <QuestionItem id="q14" question="Is SEO a one-time service or ongoing for pool companies?">
            <p><strong>Direct Answer:</strong> SEO is an ongoing service, not a one-time project. Pool companies need continuous optimization because Google's algorithm changes, competitors improve, and your business grows into new service areas.</p>

            <div>
              <p><strong>Why SEO Requires Ongoing Work:</strong></p>
              
              <p><strong>Algorithm Updates:</strong><br/>
              Google updates its algorithm hundreds of times per year. What works today may need adjustment tomorrow to maintain rankings.</p>

              <p><strong>Competitive Landscape:</strong><br/>
              Other pool companies are constantly improving their SEO. Standing still means falling behind competitors who are actively optimizing.</p>

              <p><strong>Business Growth:</strong><br/>
              As your pool company expands to new areas or adds services, you need SEO for new keywords and locations.</p>
            </div>

            <div>
              <p><strong>Ongoing SEO Activities:</strong></p>
              <ul className="ml-6 space-y-1 mt-2">
            ...
            <div>
              ...
              <p>Most pool companies see initial results in 3-6 months, significant improvements in 6-12 months, and long-term dominance after 12+ months of consistent optimization.</p>
            </div>

            <p><strong>Think of SEO like pool maintenance:</strong> It requires regular attention to maintain results, but the compound benefits make it incredibly valuable over time.</p>
          </QuestionItem>

          <QuestionItem id="q15" question="How do pool companies show up in Google Maps?">
            <p><strong>Direct Answer:</strong> Pool companies appear in Google Maps through Google Business Profile optimization, consistent local citations, customer reviews, and location-specific SEO strategies.</p>

            <div>
              <p><strong>Google Business Profile Optimization:</strong></p>
              
              <p><strong>Complete Your Profile:</strong><br/>
              Fill out every section including business hours, services, photos, and description. Google treats complete profiles as more relevant for local searches.</p>

              <p><strong>Regular Updates:</strong><br/>
              Post weekly project photos, company updates, and seasonal promotions. Active profiles rank higher in map results.</p>

              <p><strong>Category Selection:</strong><br/>
              Choose primary categories like "Pool Contractor," "Pool Cleaning Service," or "Swimming Pool Supply Store" that match your main services.</p>
            </div>
            ...
            <div>
              <p><strong>Local Citation Building:</strong></p>
              <p>Get listed in local directories, chamber of commerce, and industry associations. Ensure your business name, address, and phone number (NAP) are identical across all platforms.</p>
            </div>

            <p><strong>Pro Tip:</strong> Google Maps rankings prioritize proximity, relevance, and prominence. You can't change proximity, but you can improve relevance through keywords and prominence through reviews and citations.</p>
          </QuestionItem>

          <QuestionItem id="q16" question="Does SEO help with seasonal pool services?">
            <p><strong>Direct Answer:</strong> Yes, SEO is perfect for seasonal pool services. It captures customers planning ahead during off-seasons and dominates high-demand periods when customers actively search for pool services.</p>

            <div>
              <p><strong>Seasonal SEO Strategy:</strong></p>
              
              <p><strong>Year-Round Content:</strong><br/>
              Create content for all seasons: spring opening guides, summer maintenance tips, fall winterization, and winter planning resources. This captures searches throughout the year.</p>

              <p><strong>Early-Bird Campaigns:</strong><br/>
              Optimize for early-season searches like "pool opening service" in late winter when customers plan ahead. Early optimization captures customers before peak season competition.</p>

              <p><strong>Peak Season Dominance:</strong><br/>
              When demand peaks in spring/summer, your SEO foundation helps you capture maximum search volume for "pool cleaning," "pool repair," and "pool maintenance."</p>
            </div>

            <div>
              <p><strong>Seasonal Content Examples:</strong></p>
              <ul className="ml-6 space-y-1 mt-2">
            ...
            <div>
              <p><strong>Benefits for Seasonal Businesses:</strong></p>
              <p>SEO works 24/7 capturing leads even during slower periods. Pool cleaning companies report 2-3x more spring inquiries when they maintain SEO during winter months.</p>
            </div>

            <p><strong>Strategy:</strong> Build SEO authority during off-seasons, then dominate when demand peaks. This approach generates more leads at lower costs than competing only during busy periods.</p>
          </QuestionItem>

          <QuestionItem id="q17" question="What is local SEO for pool cleaning companies?">
            <p><strong>Direct Answer:</strong> Local SEO for pool cleaning companies focuses on dominating specific neighborhoods and service areas through location-based optimization, route-efficient targeting, and community engagement.</p>

            <div>
              <p><strong>Neighborhood-Specific Optimization:</strong></p>
              
              <p><strong>Service Area Pages:</strong><br/>
              Create dedicated pages for each neighborhood you serve: "Pool Cleaning in [Neighborhood]" with local information, customer testimonials, and area-specific content.</p>

              <p><strong>Route-Based Marketing:</strong><br/>
              Target zip codes where you already provide services. Cluster customers geographically for efficiency while building local market dominance.</p>

              <p><strong>Hyperlocal Keywords:</strong><br/>
              Optimize for specific searches like "pool cleaning Scottsdale Ranch" or "pool service Paradise Valley" rather than broad city-wide terms.</p>
            </div>

            <div>
              <p><strong>Local Business Strategies:</strong></p>
              <ul className="ml-6 space-y-1 mt-2">
            ...
            <div>
              ...
              <p>Create location-specific content addressing local challenges: "Pool Maintenance in Arizona Heat" or "Algae Prevention During Florida Rainy Season."</p>
            </div>

            <p><strong>Why This Works:</strong> Pool cleaning is a local, recurring service. Customers prefer nearby companies for convenience and faster response. Local SEO helps you dominate your immediate service area before expanding.</p>
          </QuestionItem>

          <QuestionItem id="q18" question="Can SEO help pool companies rank for 'near me' searches?">
            <p><strong>Direct Answer:</strong> Yes, SEO is essential for "near me" searches. These searches represent high-intent local customers and can be captured through local SEO optimization, Google Business Profile management, and location-based content.</p>

            <div>
              <p><strong>Near Me Search Optimization:</strong></p>
              
              <p><strong>Google Business Profile:</strong><br/>
              Complete and active profiles are crucial for "near me" visibility. Google uses your business location, category, and activity level to determine "near me" rankings.</p>

              <p><strong>Location Pages:</strong><br/>
              Create pages for each service area with local keywords, testimonials, and area-specific information. This helps Google understand your service coverage.</p>

              <p><strong>Mobile Optimization:</strong><br/>
              Most "near me" searches happen on mobile devices. Ensure your website loads quickly and contact information is easily accessible for immediate calls.</p>
            </div>

            <div>
              <p><strong>Key Ranking Factors:</strong></p>
              <ul className="ml-6 space-y-1 mt-2">
            ...
            <div>
              <p><strong>Content Strategy:</strong></p>
              <p>Include location-based content naturally: "Our pool cleaning technicians serve [area] and surrounding neighborhoods" or "Licensed pool contractors serving [city] since [year]."</p>
            </div>

            <p><strong>Impact:</strong> "Near me" searches often convert at higher rates because customers are ready to contact local businesses immediately. Optimizing for these searches captures high-value local leads.</p>
          </QuestionItem>

          <QuestionItem id="q19" question="Should pool companies invest in video SEO?">
            <p><strong>Direct Answer:</strong> Yes, pool companies should absolutely invest in video SEO. Video generates 5x more engagement than static posts and is perfect for showcasing pool transformations, construction processes, and maintenance tutorials.</p>

            <div>
              <p><strong>Why Video Works for Pool Companies:</strong></p>
              
              <p><strong>Visual Nature of Pool Business:</strong><br/>
              Pools are highly visual products. Before/after transformations, time-lapse installations, and design showcases perform exceptionally well in video format.</p>

              <p><strong>Customer Education:</strong><br/>
              Video tutorials about pool maintenance, seasonal care, and troubleshooting establish your expertise while helping customers, building trust and authority.</p>

              <p><strong>Search Engine Benefits:</strong><br/>
              Google owns YouTube and favors video content in search results. Video-optimized pages often rank higher than text-only content.</p>
            </div>

            <div>
              <p><strong>Effective Video Types for Pool Companies:</strong></p>
              <ul className="ml-6 space-y-1 mt-2">
                <li>• Time-lapse pool installation and construction</li>
                <li>• Before/after project showcases with customer testimonials</li>
            ...
            <div>
              <p><strong>Video SEO Strategy:</strong></p>
              <p>Optimize video titles and descriptions with local keywords, create compelling thumbnails, add captions for accessibility, and embed videos on relevant website pages to boost overall page authority.</p>
            </div>

            <p><strong>ROI Impact:</strong> Pool companies using video content report higher engagement rates, longer website visits, and increased conversion rates compared to text-only marketing approaches.</p>
          </QuestionItem>

          <QuestionItem id="q20" question="Do pool companies need schema markup?">
            <p><strong>Direct Answer:</strong> Yes, pool companies should implement schema markup. It helps search engines understand your business information, improves local search visibility, and enables rich snippets that can increase click-through rates.</p>

            <div>
              <p><strong>Essential Schema Types for Pool Companies:</strong></p>
              
              <p><strong>Local Business Schema:</strong><br/>
              Include business name, address, phone number, hours, and service areas. This helps Google display accurate information in local search results and maps.</p>

              <p><strong>Service Schema:</strong><br/>
              Mark up your services like "Pool Installation," "Pool Cleaning," or "Pool Repair" with descriptions, service areas, and pricing information when appropriate.</p>

              <p><strong>Review Schema:</strong><br/>
              Display star ratings in search results by marking up customer reviews, which can significantly increase click-through rates from search results.</p>
            </div>

            <div>
              <p><strong>FAQ Schema Benefits:</strong></p>
              <ul className="ml-6 space-y-1 mt-2">
                <li>• Enables direct answers in Google search results</li>
                <li>• Makes content accessible to AI tools like ChatGPT and Perplexity</li>
                <li>• Increases chances of appearing in voice search results</li>
            ...
            <div>
              ...
              <p>Start with Local Business and Service schema, then add FAQ schema for common customer questions, and Review schema to showcase customer satisfaction in search results.</p>
            </div>

            <p><strong>Competitive Advantage:</strong> Most pool companies don't use schema markup yet, so implementing it gives you a technical SEO advantage and better search result appearance than competitors.</p>
          </QuestionItem>

          <QuestionItem id="q21" question="Do I need a blog if I'm a pool builder?">
            <p><strong>Direct Answer:</strong> Yes, a blog is essential for pool builders. It establishes expertise, captures search traffic for pool-related questions, nurtures leads during long decision cycles, and builds the authority needed for strong SEO rankings.</p>

            <div>
              <p><strong>Why Blogging Works for Pool Builders:</strong></p>
              
              <p><strong>Long Sales Cycles:</strong><br/>
              Pool installation is a major decision with 6-18 month consideration periods. Blog content keeps you top-of-mind throughout the customer's research and planning phase.</p>

              <p><strong>Educational Authority:</strong><br/>
              Homeowners have many questions about pools: permits, costs, timelines, maintenance. Your blog answers these questions, positioning you as the local expert.</p>

              <p><strong>Search Traffic Capture:</strong><br/>
              Blog posts target informational keywords that bring qualified traffic: "pool installation process," "pool permit requirements," or "pool maintenance costs."</p>
            </div>

            <div>
              <p><strong>High-Converting Blog Topics:</strong></p>
              <ul className="ml-6 space-y-1 mt-2">
            ...
            <div>
              <p><strong>SEO and Lead Generation Benefits:</strong></p>
              <p>Each blog post creates a new page that can rank for relevant keywords, bringing qualified traffic. Include calls-to-action in every post like "Schedule Free Design Consultation" to convert readers into leads.</p>
            </div>

            <p><strong>Content Strategy:</strong> Publish 1-2 high-quality, locally-focused blog posts per month addressing real customer questions. This builds authority faster than competitors while generating consistent organic traffic.</p>
          </QuestionItem>
        </div>
        ...
        <div className="bg-black text-white p-8 rounded-lg text-center">
          ...
          <p className="text-gray-300 mb-6">
            Get personalized answers and a custom AI marketing strategy for your pool company.
          </p>
