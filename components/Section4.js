  ...
  return (
    <>
      <div className=' bg-slate-400 bg-[url("/images/pool-builder-smiling-in-front-of-pool.jpg")] bg-blend-multiply bg-no-repeat bg-cover bg-fixed'>
        <div className="container max-w-7xl mx-auto px-6 py-40">
          <h2 className="text-5xl font-bold text-white mb-4 leading-tight text-center max-w-4xl mx-auto">
            Pool Marketing That Takes Your Business To The Next Level
          </h2>
          <p className="text-xl text-white max-w-2xl mx-auto text-center mb-10">
          ...
          <div className=" flex flex-col gap-10 max-w-3xl text-white">
            <div className="pb-10 rounded-3xl">
              <p className="text-4xl px-10 pt-10 font-light max-w-3xl">
                Showcase Your Best Work. Convert Visitors Into Clients.
              </p>
              <p className="text-2xl px-10 py-6 font-extrabold max-w-xl text-orange-600">
                Professional Web Design That Works as Hard as You Do
              </p>
              <p className="text-xl px-10 font-light max-w-2xl mb-4">
              ...
              <ul className="px-10 py-4 ">
                <li className="text-xl pb-4 flex items-start">
            ...
            <div className="pb-10 rounded-3xl">
              <p className="text-4xl px-10 pt-10 font-light max-w-2xl">
                Automate Follow-Up. Close More Deals.
              </p>
              <p className="text-2xl px-10 py-6 font-black max-w-2xl text-orange-600">
            ...
            <div className="pb-10 rounded-3xl">
              <p className="text-4xl px-10 pt-10 font-light max-w-2xl">
                Be the Builder They Find First.
              </p>
              <p className="text-2xl px-10 py-6 font-black max-w-2xl text-orange-600">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-xl px-10 py-10 text-white">
              If you’re nodding along thinking,{' '}
              <span className="italic font-bold">
                “This is exactly what I need,”
              </span>
              you’re in the right place. My goal isn’t just to build you a
              website or run ads. It’s to become your marketing partner in
              turning your pool company into a more profitable, in-demand
              business.
            </p>
          </div>
          <Button
