  ...
  return (
    <div className="container max-w-8xl mx-auto px-4 my-10 lg:my-20">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="lg:border-[1px] border-slate-100 hover:bg-green-600 hover:text-white p-6 lg:py-20 rounded-3xl lg:shadow-xl">
          <p className="text-3xl lg:text-4xl lg:px-10 lg:pt-10 font-bold max-w-md ">
            Foundation Package
          </p>
        ...
        <div className="lg:border-[1px] border-slate-100 hover:bg-green-600 hover:text-white p-6 lg:py-20 rounded-3xl lg:shadow-xl">
          ...
          <p className="text-[1.3rem] lg:px-10">Includes:</p>
          <p className="text-[1.3rem] pt-2 lg:px-10">Everything in Momentum</p>
          <p className="text-[1.3rem] pt-2 lg:px-10">
      ...
      <WeakDesignCTA label="choose_package_section" />
    </div>
  )
}
